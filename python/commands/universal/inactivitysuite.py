...
def setup(tree: app_commands.CommandTree):    
    ...
    async def notice(intact: Interaction):
        try:
            ...
            i = await tree.client.get_guild(926850392271241226).get_channel(1308928443974684713).send(embed=Embed(title=f"[Error][Inactivity {inspect.currentframe().f_code.co_name}]", description=format_exc(5)))
